...
echo '<h5>' . $data['Content']['HTML'] . '</h5><img src="' . $data['Content']['imageetoile'] . '" class="etoile" ,class="titreaug">';
echo '<h5>' .$data['Content']['CSS'] . '</h5><img src="' .$data['Content']['imageetoile'] .'"class="etoile">';
echo '<h5>' .$data['Content']['JS'] . '</h5><img src="' .$data['Content']['imageetoile2'] .'"class="etoile2">';
echo '<h5>' .$data['Content']['PHP'] . '</h5><img src="' .$data['Content']['imageetoile2'] .'"class="etoile2">';
echo '<h5>' .$data['Content']['PYTHON'] . '</h5><img src="' .$data['Content']['imageetoile2'] .'"class="etoile2">';
echo '<p>' .$data['Content']['reseau'] . '</p><img src="' .$data['Content']['imageetoile'] .'"class="etoile">';
echo '<h2>' .$data['Content']['Langues'] . '</h2>';
